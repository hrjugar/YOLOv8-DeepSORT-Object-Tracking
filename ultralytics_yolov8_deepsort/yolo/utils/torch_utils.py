...
from ultralytics_yolov8_deepsort.yolo.utils import DEFAULT_CONFIG_DICT, DEFAULT_CONFIG_KEYS, LOGGER
from ultralytics_yolov8_deepsort.yolo.utils.checks import git_describe
...
def select_device(device='', batch_size=0, newline=False):
    ...
    ver = git_describe() or ultralytics_yolov8_deepsort.__version__  # git commit or pip package version
