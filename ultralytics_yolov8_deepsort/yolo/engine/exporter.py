...
import ultralytics_yolov8_deepsort
from ultralytics_yolov8_deepsort.nn.modules import Detect, Segment
from ultralytics_yolov8_deepsort.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel
from ultralytics_yolov8_deepsort.yolo.configs import get_config
from ultralytics_yolov8_deepsort.yolo.data.dataloaders.stream_loaders import LoadImages
from ultralytics_yolov8_deepsort.yolo.data.utils import check_dataset
from ultralytics_yolov8_deepsort.yolo.utils import DEFAULT_CONFIG, LOGGER, callbacks, colorstr, get_default_args, yaml_save
from ultralytics_yolov8_deepsort.yolo.utils.checks import check_imgsz, check_requirements, check_version, check_yaml
from ultralytics_yolov8_deepsort.yolo.utils.files import file_size
from ultralytics_yolov8_deepsort.yolo.utils.ops import Profile
from ultralytics_yolov8_deepsort.yolo.utils.torch_utils import guess_task_from_head, select_device, smart_inference_mode
...
class Exporter:
    ...
    def _pipeline_coreml(self, model, prefix=colorstr('CoreML Pipeline:')):
        ...
        pipeline.spec.description.metadata.versionString = f'Ultralytics YOLOv{ultralytics_yolov8_deepsort.__version__}'
...
def export(cfg):
    ...
    from ultralytics_yolov8_deepsort import YOLO
