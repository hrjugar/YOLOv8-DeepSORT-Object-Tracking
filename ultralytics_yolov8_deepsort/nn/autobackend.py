...
from ultralytics_yolov8_deepsort.yolo.utils import LOGGER, ROOT, yaml_load
from ultralytics_yolov8_deepsort.yolo.utils.checks import check_requirements, check_suffix, check_version
from ultralytics_yolov8_deepsort.yolo.utils.downloads import attempt_download, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(self, weights='yolov8n.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if nn_module:
            ...
            from ultralytics_yolov8_deepsort.nn.tasks import attempt_load_weights
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from ultralytics_yolov8_deepsort.yolo.engine.exporter import export_formats
    ...
    def _load_metadata(f=Path('path/to/meta.yaml')):
        ...
        """
        from ultralytics_yolov8_deepsort.yolo.utils.files import yaml_load
