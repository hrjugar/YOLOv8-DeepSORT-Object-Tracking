...
from ultralytics_yolov8_deepsort.nn.modules import (C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x, Classify,
                                    Concat, Conv, ConvTranspose, Detect, DWConv, DWConvTranspose2d, Ensemble, Focus,
                                    GhostBottleneck, GhostConv, Segment)
from ultralytics_yolov8_deepsort.yolo.utils import DEFAULT_CONFIG_DICT, DEFAULT_CONFIG_KEYS, LOGGER, colorstr, yaml_load
from ultralytics_yolov8_deepsort.yolo.utils.checks import check_yaml
from ultralytics_yolov8_deepsort.yolo.utils.torch_utils import (fuse_conv_and_bn, initialize_weights, intersect_dicts, make_divisible,
...
def attempt_load_weights(weights, device=None, inplace=True, fuse=False):
    ...
    from ultralytics_yolov8_deepsort.yolo.utils.downloads import attempt_download
